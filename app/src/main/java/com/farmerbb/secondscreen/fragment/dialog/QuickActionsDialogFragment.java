...
// This dialog is shown only once when QuickActionsActivity is run for the first time.
public final class QuickActionsDialogFragment extends DialogFragment {
