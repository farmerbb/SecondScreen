...
// DialogFragment shown when the user has tested overscan values via the OverscanFragment, and
// the profile they are editing is currently active.  It allows the user to continue using the
// tested overscan values.
public final class KeepOverscanDialogFragment extends DialogFragment {
