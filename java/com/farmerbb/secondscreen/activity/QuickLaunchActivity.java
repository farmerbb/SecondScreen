...
public final class QuickLaunchActivity extends Activity {
    ...
    private void loadProfile(String filename) throws IOException {
        ...
        if(filename.equals("turn_off"))
            resultIntent.putExtra(com.twofortyfouram.locale.Intent.EXTRA_STRING_BLURB, getResources().getString(R.string.dialog_turn_off_title));
        else
            resultIntent.putExtra(com.twofortyfouram.locale.Intent.EXTRA_STRING_BLURB, U.getProfileTitle(this, filename));
