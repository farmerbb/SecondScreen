 ...
 */
public final class PluginBundleManagerQuickActions
{
    /**
     * Type: {@code String}.
     * <p>
     ...
     */
    public static final String BUNDLE_EXTRA_STRING_KEY = "com.farmerbb.secondscreen.STRING_KEY"; //$NON-NLS-1$
    public static final String BUNDLE_EXTRA_STRING_VALUE = "com.farmerbb.secondscreen.STRING_VALUE"; //$NON-NLS-1$
    ...
    public static boolean isBundleValid(final Bundle bundle)
    {
         ...
         */
        if (!bundle.containsKey(BUNDLE_EXTRA_STRING_KEY))
            return false;

        if (!bundle.containsKey(BUNDLE_EXTRA_STRING_VALUE))
            return false;
    ...
    public static Bundle generateBundle(final Context context, final String key, final String value)
    {
        ...
        result.putString(BUNDLE_EXTRA_STRING_KEY, key);
        result.putString(BUNDLE_EXTRA_STRING_VALUE, value);
     ...
     */
    private PluginBundleManagerQuickActions()
    {
